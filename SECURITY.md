...
csharp-agent is designed for **legitimate security research, authorized penetration testing, and
...
If you discover a security vulnerability in csharp-agent, please report it **privately** rather
than opening a public issue.

### How to Report

1. **Email:** Send a detailed report to the project maintainer (see GitHub profile for contact information)
2. **GitHub Security Advisories:** Use [GitHub's private vulnerability reporting](https://github.com/mrzaxaryan/csharp-agent/security/advisories/new) to submit a confidential advisory

### What to Include

- A clear description of the vulnerability
- Steps to reproduce the issue
- The affected host (mshta, cscript, or a standalone .NET host) and Windows version
...
- Misuse of csharp-agent for unauthorized purposes
